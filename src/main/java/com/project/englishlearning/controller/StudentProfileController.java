...
public class StudentProfileController {
    ...
    public StudentProfileController(UserRepository userRepository, TestResultRepository testResultRepository,
    ...
    public String viewProfile(Authentication authentication, Model model) {
        ...
        model.addAttribute("writingSubmissions",
                writingSubmissionRepository.findByUserIdOrderBySubmittedAtDesc(user.getId()));
